...
if __name__ == '__main__':
  ...
  if args.dataset == "pascal_voc":
      ...
      args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
  elif args.dataset == "sate_airports":
      args.imdb_name = "sate_airports_trainval"
      args.imdbval_name = "sate_airports_test"
  ...
  imdb, roidb, ratio_list, ratio_index = combined_roidb(args.imdb_name, args.modif)
    ...
    for step in range(iters_per_epoch):
      ...
      if step % args.disp_interval == 0:
        ...
        print("[session %d][epoch %2d][iter %4d/%4d] %s, lr: %.2e" \
                                % (args.session, epoch, step, iters_per_epoch, colored('loss: %.4f' % loss_temp, 'green', attrs=['bold']), lr))
